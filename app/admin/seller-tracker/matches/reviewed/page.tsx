...
export const metadata: Metadata = {
  title: "Reviewed Matches | Seller Tracker | Tiffany Cards",
  description:
    "Private Tiffany Cards administration page for viewing completed Seller Tracker match reviews.",
  robots: {
    index: false,
    follow: false,
  },
...
async function getMatches(): Promise<{
  ...
  try {
    ...
    const url =
      `${protocol}://${host}` +
      "/api/seller-tracker?action=matches&reviewStatus=completed";
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-zinc-400">
                View candidate matches that have already been reviewed
                and marked as Confirmed Match or Not a Match.
              </p>
            </div>
            ...
            <section className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-8 text-center">
              <div className="mx-auto max-w-xl">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-400">
                  There are currently no completed match reviews.
                  Records will appear here after a candidate is marked
                  Confirmed Match or Not a Match.
                </p>
